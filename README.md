I used Robust Scaler as a data normlazation method; it is a better appraoch than Min-Max because our data has outliers and if we use Min-Max then it will mess with SMOTE's output.
